...
Las órdenes de Loopring se expresan en lo que definimos como Modelo de Órden Unidireccional (UDOM, del inglés \textit{Unidirectional Order Model}) \cite{coinport2014udom}. UDOM expresa las órdenes como peticiones de intercambio de tókenes, \verb|cantidadV|/\verb|cantidadC|, (cantidad a vender/comprar)  en lugar de precios de compra y venta. Como cada órden es simplemente un tipo de cambio entre dos tokens, una característica potente del protocolo es la mezcla y combinación de múltiples ordenes en un intercambio circular. Al usar hasta 16 órdenes en lugar de un sólo par de cambio, esto permite que haya un aumento drástico de la liquidez y la posibilidad de una mejora del precio. 
...
\caption{Una orden anular compuesta de 3 órdenes}
\label{fig:ring}
\end{figurehere}
\end{center}
