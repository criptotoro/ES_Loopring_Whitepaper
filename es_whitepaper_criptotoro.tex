...
El resultado es un conjunto de silos de liquidez desconectados y un ecosistema fragmentado que se asemeja al antiguo sistema financiero, con los únicos volúmenes de cambio significativos centralizados en unas pocas casas de cambio. Las promesas de liquidez global debido a la cadena de bloques no tienen ningúna virtud en las casas de cambio centralizadas.
